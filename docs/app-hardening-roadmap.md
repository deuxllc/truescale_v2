...
- Domain code is now split into dedicated modules for geometry, measurement, dialogs, project format, detection, snapping, export, and the segments panel.
...
- Continue reducing `app.js` by extracting state/history, canvas transforms, renderer, and interaction controllers.
